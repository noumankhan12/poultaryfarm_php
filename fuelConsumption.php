            ...
            <div class="main__container">
                <table>
                    ...
                    <tbody>
                        ...
                        $record=mysqli_query($conn,"SELECT *FROM fuel_consumption ");
                ...
                $updateQuery = "UPDATE fuel_consumption SET total_consumption = '$totalConsumption'";
                ...
                <form action="fuel-consumption-action.php" method="post">
