                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_array($record)) {
                            ...
                            <tr>
                                ...
                                <td>
                                <td>
    <a class="del_btn" href="delete-medicine.php?ID=<?php echo $row['MedicinePurchase_ID']; ?>">Delete</a>
</td>
                ...
                $totalprice=$totalprice*$totalProduction;
                // Update the total_quantity column in the medicinePurchase table
                $updateQuery = "UPDATE medicinepurchase SET totalquantity = '$totalProduction'";
                $updateQuery = "UPDATE medicinepurchase SET totalprice = '$totalprice'";
                ...
                <div class="main__container">
                    <form action="medicinePurchase-action.php" method="post">
            ...
            <?php
                        ...
                        $recordPurchase = mysqli_query($con, "SELECT SUM(quantity) AS totalquantity FROM medicinepurchase");
                        ...
                        $recordBought = mysqli_query($con, "SELECT SUM(quantity) AS total_consumption FROM medicine_consumption");
