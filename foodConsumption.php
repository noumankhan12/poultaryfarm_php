            ...
            <div class="main__container">
                <table>
                    ...
                    <tbody>
                        ...
                        $record=mysqli_query($conn,"SELECT *FROM food_consumption ");
                ...
                $updateQuery = "UPDATE food_consumption SET total_consumption = '$totalConsumption'";
                ...
                <form action="food-consumption-action.php" method="post">
