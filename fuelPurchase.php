                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_array($record)) {
                            ...
                            <tr>
                                ...
                                <td>
                                <td>
    <a class="del_btn" href="delete-fuel.php?ID=<?php echo $row['ID']; ?>">Delete</a>
</td>
                ...
                $updateQuery = "UPDATE fuel_production SET totalquantity = '$totalProduction'";

                if ($conn->query($updateQuery) === TRUE) {
                    echo "Total production updated in the  table successfully.";
                } else {
                ...
                <div class="main__container">
                    <form action="fuel-purchase-action.php" method="post">
            ...
            <?php
                        ...
                        $recordPurchase = mysqli_query($con, "SELECT SUM(quantity) AS totalquantity FROM fuel_production");
                        ...
                        $recordBought = mysqli_query($con, "SELECT SUM(quantity) AS total_consumption FROM fuel_consumption");
